...
import com.mayankPaliwal.utils.TakeScreenshot;
...
public class TestVWOLogin_Prop_Screenshot_POM extends CommonToAllTest {
    ...
    private static final Logger logger = LogManager.getLogger(TestVWOLogin_Prop_Screenshot_POM.class);
    ...
    public void test_login_positive_vwo() {
        ...
        try {
            ...
            new TakeScreenshot().takeScreenshot("This is dashboard page");
