package com.mayankPaliwal.tests.vwo.pageFactory;
...
public class TestVWOLogin_PageFactory_POM extends CommonToAllTest {


    private static final Logger logger = LogManager.getLogger(TestVWOLogin_PageFactory_POM.class);
    ...
    public void test_login_negative_vwo() {
        ...
        logger.info("error message i got "+err_msg);
